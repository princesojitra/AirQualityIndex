...
#ifndef DTTABLEVIEWMANAGER_SWIFT_H
#define DTTABLEVIEWMANAGER_SWIFT_H
...
- (BOOL)tableView:(UITableView * _Nonnull)tableView shouldShowMenuForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(tvos,deprecated=13.0) SWIFT_AVAILABILITY(ios,deprecated=13.0);
- (BOOL)tableView:(UITableView * _Nonnull)tableView canPerformAction:(SEL _Nonnull)action forRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath withSender:(id _Nullable)sender SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(tvos,deprecated=13.0) SWIFT_AVAILABILITY(ios,deprecated=13.0);
- (void)tableView:(UITableView * _Nonnull)tableView performAction:(SEL _Nonnull)action forRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath withSender:(id _Nullable)sender SWIFT_AVAILABILITY(tvos,deprecated=13.0) SWIFT_AVAILABILITY(ios,deprecated=13.0);
/// Implementation for <code>UITableViewDelegate</code> protocol
...
- (void)tableViewDidEndMultipleSelectionInteraction:(UITableView * _Nonnull)tableView SWIFT_AVAILABILITY(ios,introduced=13.0);
...
/// Object, that implements <code>UITableViewDragDelegate</code> methods for <code>DTTableViewManager</code>.
SWIFT_CLASS("_TtC18DTTableViewManager23DTTableViewDragDelegate")
@interface DTTableViewDragDelegate : DTTableViewDelegateWrapper <UITableViewDragDelegate>
/// Implementation for <code>UITableViewDragDelegate</code> protocol
...
/// Implementation for <code>UITableViewDragDelegate</code> protocol
- (BOOL)tableView:(UITableView * _Nonnull)tableView dragSessionAllowsMoveOperation:(id <UIDragSession> _Nonnull)session SWIFT_WARN_UNUSED_RESULT;
/// Implementation for <code>UITableViewDragDelegate</code> protocol
- (BOOL)tableView:(UITableView * _Nonnull)tableView dragSessionIsRestrictedToDraggingApplication:(id <UIDragSession> _Nonnull)session SWIFT_WARN_UNUSED_RESULT;
@end
...
/// Object, that implements <code>UITableViewDropDelegate</code> for <code>DTTableViewManager</code>.
SWIFT_CLASS("_TtC18DTTableViewManager23DTTableViewDropDelegate")
@interface DTTableViewDropDelegate : DTTableViewDelegateWrapper <UITableViewDropDelegate>
/// Implementation for <code>UITableViewDropDelegate</code> protocol
...
/// Implementation for <code>UITableViewDropDelegate</code> protocol
- (UIDragPreviewParameters * _Nullable)tableView:(UITableView * _Nonnull)tableView dropPreviewParametersForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end
